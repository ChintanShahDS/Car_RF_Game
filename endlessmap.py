...
Config.set('graphics', 'height', '899')
# Config.set('graphics', 'minimum_width', '1200')
# Config.set('graphics', 'minimum_height', '899')
...
last_reward = 0
scores = []
im = CoreImage("./map/EndlessSpace_mask1.png")
...
def init():
    ...
    img = PILImage.open("./map/EndlessSpace_mask1_upd.png").convert('L')
...
class Car(Widget):
    ...
    def move(self, rotation):
        ...
        self.sensor2 = Vector(40, 0).rotate((self.angle+30)%360) + self.pos
        self.sensor3 = Vector(40, 0).rotate((self.angle-30)%360) + self.pos
...
class Game(Widget):
    ...
    def update(self, dt):
        ...
        print(mapwidth, mapheight, goal_x, goal_y, distance, int(self.car.x),int(self.car.y), last_reward, locReward, distReward, dirReward, edgeReward)
